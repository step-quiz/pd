...
\begin{sollist}
  ...
  \item $R=-1$ \;(cal anar amb compte amb el signe del terme $-2x^2$:
        $-2\per 2^2=-8$)
  \item $C(100)=0$: la família no paga res; la seva renda es troba just al
        llindar on el copagament s'anul·la (per sota, la fórmula donaria
        valors que cal interpretar com a copagament nul).
\end{sollist}
\end{solucions}
